...
var __extends2 = (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ _proto_: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) {
            for (var p in b)
...
function VueComponentAutoRegister(componentName) {
    return function (target) {
        if (typeof allRegisteredVueComponents[componentName] === 'undefined') {
            ...
            var metadata_1 = {
                watch: [], vars: [], computed: [], updated: null, mounted: null, params: {}
            };
            if (typeof instance_1.metadata !== 'undefined') {
                metadata_1 = instance_1.metadata;
            }
            var props = [];
            ...
            for (var varName in metadata_1.watch) {
                ...
                if (descriptor.deep)
                    watch[varName] = {
                        handler: instance_1[descriptor.funcName],
                        deep: true
                    };
                else
                    watch[varName] = instance_1[descriptor.funcName];
            }
            ...
            //console.log('Registering component '+componentName+' finalized');
        }
        else {
